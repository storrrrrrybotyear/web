...
const assistantResponses = [
  { pattern: /كيفية|كيف أقدم|طريقة التقديم/i, answer: 'لتقديم طلب وظيفة، اختر الوظيفة المناسبة ثم اضغط "تقديم" ثم اتبع التعليمات في صفحة الوظائف.' },
  { pattern: /شروط|قبول/i, answer: 'الشروط تعتمد على المؤهل والخبرة والمهارات. ننصح بتحسين السيرة الذاتية وتحديث ملفك الشخصي.' },
  { pattern: /الفروع|الموقع/i, answer: 'يمكنك زيارة صفحة فروع الوزارة للبحث حسب المدينة ومعرفة الخدمات المتاحة لكل فرع.' },
  { pattern: /مواعيد|دوام/i, answer: 'تعمل الفروع عادة من 8 صباحًا حتى 4 مساءً في أيام الأسبوع، ويمكنك التأكد من الفرع المحدد في صفحة الفروع.' },
  { pattern: /السيرة|cv|resume/i, answer: 'رفع سيرتك الذاتية للحصول على تقييم جودة، نقاط القوة، ونصائح لتحسينها قبل التقديم.' }
];
